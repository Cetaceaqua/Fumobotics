...
private:
  const int adc_key_min_values[16] = { 25, 230, 470, 70, 280, 530, 110, 350, 600, 400, 180, 640, 680, 730, 790, 860 };
  const int adc_key_max_values[16] = { 40, 260, 500, 100, 310, 560, 140, 380, 630, 430, 210, 660, 710, 760, 820, 890 };
